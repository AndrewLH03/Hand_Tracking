...
Updated to use unified connection manager and utilities.
"""
...
class RobotController:
    ...
    def __init__(self, connection_manager: ConnectionManager):
        ...
        Args:
            connection_manager: ConnectionManager instance for connectivity
        """
        self.connection = connection_manager
        self.dashboard = connection_manager.get_dashboard_api()
...
class RobotSystem:
    ...
    def __init__(self, robot_ip: str = "192.168.1.6"):
        ...
        """
        self.connection = get_connection_manager(robot_ip)
    ...
    def perform_preflight_check(self):
        ...
        dashboard = self.connection.get_dashboard_api()
        if dashboard is None:
            return False, {}, ["No dashboard API available"]
        
        # Test basic command
        success, message, response = execute_robot_command(dashboard, "GetPose")
        if success:
            return True, {"connection": "OK", "position": response}, ["Preflight check passed"]
        else:
            return False, {"connection": "FAILED"}, [message]
