...
def show_usage_guide():
    ...
    print("\\n1. BASIC STARTUP:")
    print("   python startup.py --robot-ip 192.168.5.1")
    
    print("\\n2. SIMULATION MODE (no robot):")
    ...
    print("\\n4. CUSTOM SETTINGS:")
    print("   python startup.py --robot-ip 192.168.5.1 --hand Left --mirror")
...
def main():
    ...
    parser.add_argument('--robot-ip', default='192.168.5.1', 
                       help='Robot IP address (default: 192.168.5.1)')
